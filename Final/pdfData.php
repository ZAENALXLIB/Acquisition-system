...
$data_pengunjung = mysqli_query($koneksi, "SELECT * FROM esp32_table_dht11_leds_record ORDER BY time ASC");
...
$content = '
<page>
    <h2 align="center">Data Sensor DHT11</h2>
    <table border="1" align="center" style="width: 100%; border-collapse: collapse;">
        <tr>
            ...
            <th align="center">Status Read Sensor DHT11</th>
...
while ($sensor = mysqli_fetch_assoc($data_pengunjung)) {
    ...
    $content .= '
        <tr>
            ...
            <td align="center">' . $sensor['temperature'] . '</td>
            <td align="center">' . $sensor['humidity'] . '</td>
            <td align="center">' . $sensor['status_read_sensor_dht11'] . '</td>
...
$html2pdf->output('data_sensor.pdf', 'D');
