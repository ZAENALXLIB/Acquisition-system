        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="text-center">
                    ...
                    <p class="statusreadColor"><span>Status Read Sensor HCSR04: </span><span id="ESP32_02_Status_Read_HCSR04"></span></p>
                </div>
            </div>
        </div>
        <!-- ======================================================================================================= -->
...
<div class="content">
    <div class="cards">
        <div class="card header" style="border-radius: 15px; min-width: 660px; text-align:center; background-color:greenyellow; color: black;">
            <h3 style="font-size: 0.7rem;">LAST TIME RECEIVED DATA FROM ESP32 [ <span id="ESP32_02_LTRD"></span> ]</h3>
        </div>
    </div>
</div>
...
<body>
    <div class="container">
        ...
        <div class="mt-3"></div>
        <h3 class="text-center">Water Level Data Monitoring</h3>
        <h3 class="text-center">Sensor HCSR04</h3>
    </div>

    <div class="card mt-3">
        <div class="card-header bg-primary text-white"><i class="fa-solid fa-list"></i> Data Water Level</div>
        <div class="card-body">

            <!-- Memberikan margin top pada tombol Download Excel -->
            <a href="/FinalHCSR04/excelData.php">
            ...
            <a href="/FinalHCSR04/pdfData.php">
                <button type="button" class="btn mb-3" style="background-color: #217346; color: white; border: none; margin-left: 10px;">
            ...
            <table class="table table-bordered table-striped table-hover mt-3" id="table_id">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">Status Read Sensor HCSR04</th>
                ...
                <tbody id="tbody_table_record">
                    ...
                    $sql = 'SELECT * FROM esp32_table_hcsr04_record ORDER BY date, time';
                    foreach ($pdo->query($sql) as $row) {
                        ...
                        // Menggunakan number_format untuk menampilkan height dengan dua desimal
                        echo '<td class="bdr text-center">' . number_format($row['height'], 2) . '</td>';
                        echo '<td class="bdr text-center">' . $row['status_read_sensor_hcsr04'] . '</td>';
