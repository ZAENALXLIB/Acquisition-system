  ...
  <table class="styled-table" id="table_id">
    <thead>
      <tr>
        ...
        <th>TEMPERATURE 4 (°C)</th>
        <th>STATUS READ SENSOR DS18B20</th>
        <th>TIME</th>
    ...
    <tbody id="tbody_table_record">
      ...
      $sql = 'SELECT * FROM esp32_table_ds18b20_record ORDER BY date, time';
      foreach ($pdo->query($sql) as $row) {
        ...
        echo '<td class="bdr">' . $row['temperature1'] . '</td>';
        echo '<td class="bdr">' . $row['temperature2'] . '</td>';
        echo '<td class="bdr">' . $row['temperature3'] . '</td>';
        echo '<td class="bdr">' . $row['temperature4'] . '</td>';
        echo '<td class="bdr">' . $row['status_read_sensor_DS18B20'] . '</td>';
