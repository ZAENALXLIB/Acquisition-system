...
// Logika untuk memeriksa sesi dan peran (boleh diakses oleh "admin" atau "user")
...
$query = mysqli_query($koneksi, "SELECT * FROM esp32_table_dht11_leds_record ORDER BY date, time");
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-striped table-hover mt-3" id="table">
                        ...
                        <tbody>
                            ...
                            $tampil = mysqli_query($koneksi, "SELECT * FROM esp32_table_dht11_leds_record ORDER BY date, time"); // Ambil data dari database
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo $data['temperature']; ?></td>
                                    <td class="text-center"><?php echo $data['humidity']; ?></td>
                                    <td class="text-center"><?php echo $data['status_read_sensor_dht11']; ?></td>
