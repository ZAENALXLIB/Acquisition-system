...
if (isset($_POST['submit'])) {
	...
	if ($cek_login > 0) {
		...
		if ($password1 != $password2) {
			...
			mysqli_query($koneksi, "INSERT INTO user (id, nama, username, password) VALUES('','$nama','$username','$password')");
...
<head>
	...
	<!-- Custom Theme files -->
	<link href="/admin/assets/register.css" rel="stylesheet" type="text/css" media="all" />
	<!-- //Custom Theme files -->
	<!-- web font -->
...
<body>
	...
	<div class="main-w3layouts wrapper">
		...
		<div class="colorlibcopy-agile">
			<p>Copyright &copy <?= date('Y') ?>Muhammad Zaenal Arifin. All rights reserved</p>
		</div>
		<!-- //copyright -->
