...
// Cek sesi login dan peran (hanya "admin" yang diizinkan)
...
// Sertakan header dengan koneksi database
include 'headerDist.php';

// Nomor WhatsApp (pastikan formatnya benar)
$WA = "628517954784";
                    ...
                    <table class="table table-bordered table-striped table-hover mt-3" id="table">
                        <thead>
                            <tr>
                                ...
                                <!-- <th class="text-center">Status Read Sensor HC-SR04</th> -->
                        ...
                        <tbody>
                            ...
                            $tampil = mysqli_query($koneksi, "SELECT * FROM esp32_table_hcsr04_record ORDER BY date, time"); // Ambil data dari database
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo $data['height']; ?></td>
                                    <!-- <td class="text-center"><?php echo $data['status_read_sensor_hcsr04']; ?></td> -->
