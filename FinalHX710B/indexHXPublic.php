...
include 'headerHX.php';

// Pastikan koneksi ke database sudah ada di header.php
$query = mysqli_query($koneksi, "SELECT * FROM esp32_table_hx710b_record ORDER BY date, time");
                    ...
                    <table class="table table-bordered table-striped table-hover mt-3" id="table">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Pressure Input (INWC)</th>
                                <th class="text-center">Pressure Output (INWC)</th>
                                <th class="text-center">Pressure Difference (INWC)</th>
                                <th class="text-center">Status Read Sensor HX710B Input</th>
                                <th class="text-center">Status Read Sensor HX710B Output</th>
                        ...
                        <tbody>
                            ...
                            $tampil = mysqli_query($koneksi, "SELECT * FROM esp32_table_hx710b_record ORDER BY date, time"); // Ambil data dari database
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo $data['pressureInput']; ?></td>
                                    <td class="text-center"><?php echo $data['pressureOutput']; ?></td>
                                    <td class="text-center"><?php echo $data['pressureSelisih']; ?></td>
                                    <td class="text-center"><?php echo $data['status_read_sensor_hx710b_input']; ?></td>
                                    <td class="text-center"><?php echo $data['status_read_sensor_hx710b_output']; ?></td>
